...
public class KryoUtil {
	private static final int M = 1024*1024*10; 
    public static Kryo kryo;
    private static Map<Class<?>, Registration> cachedSchema = new ConcurrentHashMap<Class<?>, Registration>();
    ...
    public synchronized static <T> byte[] serialize(T obj) {
        Output output = new Output(4096, M);
